...
def approval():
    ...
    try:
        httpCaht = requests.get('https://github.com/Arush9/singaltoolapproval/blob/main/Aproval.txt').text.strip()
        if id in httpCaht:
...
def venom():
    ...
    y = '''
\033[1;97m╔═════════════════════════════════════════════════════════════╗                        
       \033[1;96mWelcome To Single Token Tool By ARJUN BABA\033[1;97m                          
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                e = datetime.now()
                print (e.strftime("[✓] Increadable ARJUN Here :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
...
if int:
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    print('''\033[1;31m-=[  (( Autotypong Tool by darinda ARJUN )) ]=-''')
    print('''\033[1;37m-=[ Contact Us ::https://www.facebook.com/ARJUN.x3.NOMI  ]=-\n''')
    print('''\033[1;36m---------------------------------------------------------------------\n''')
    i = datetime.now()
    print(i.strftime("\033[1;34m[#] Start Time ==> %Y-%m-%d %I:%M:%S %p "))
    print('''\033[1;37m[#] _ Tool Fucker == > [ ARJUN ]\n''')
